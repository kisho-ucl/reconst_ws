...
class Servo(Node):
    def __init__(self):
        ...
        self.pub2 = self.create_publisher(Float32, '/servo_angle', 10)
    ...
    def find_table_location(self):
        with open('/home/realsense/reconst_ws/src/calibration_tool/calibration_tool/info/table_location.txt', 'r') as file:
            # 1行目を読み込む
